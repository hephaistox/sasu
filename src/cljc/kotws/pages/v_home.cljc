    ...
    [:div
     ...
     [:table
      [:tbody
       ...
       [:tr
        [:td
         [vclabelled-image/labelled-image
          (klinks/image-link :it)
          (klinks/route-link :it)
          nil
          :small]]
        [:td
         [:a
          (klinks/link-meta (klinks/route-link :it))
          [:p
       ...
       [:tr
        [:td
         [vclabelled-image/labelled-image
          (klinks/image-link :sc)
          (klinks/route-link :sc)
          nil
          :small]]
        [:td
         [:a
          (klinks/link-meta (klinks/route-link :sc))
          [:p
       ...
       [:tr
        [:td
         [vclabelled-image/labelled-image
          (klinks/image-link :math)
          (klinks/route-link :or)
          nil
          :small]]
        [:td
         [:a
          (klinks/link-meta (klinks/route-link :or))
          [:p
       ...
       [:tr
        [:td
         [vclabelled-image/labelled-image
          (klinks/image-link :teaching)
          (klinks/route-link :teaching)
          nil
          :small]]
        [:td
         [:a
          (klinks/link-meta (klinks/route-link :teaching))
          [:p
...
(def items
  {:docs {:caumond-resume {:fr {:img-link :caumond-cv
...
(defn v-home
  ...
  (let [{:keys [docs founding]} (defaulting* items tr)
    ...
    [:<>
     ...
     [:div.text (current-tr :home-intro)]
     [kvspace/vertical-spacing]
     [:div.text (current-tr :next)]
     [:div.w3-center
      [vclabelled-image/labelled-image
       (klinks/image-link (:img-link founding))
       (klinks/route-link :founder)
       nil
       w]]
     [kvspace/vertical-spacing]]))
