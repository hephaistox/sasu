  ...
  {:teaching {:fr "Ce site"
   ...
   {:fr
    [:div
     ...
     [:h2 "Responsive"]
     [:p
      "Quelle que soit la taille de votre écran, de votre typographie, le site s'adapte au contenu."]
     [:h2 "Code source"]
...
(defn v-this-website
  [l]
  (let [tr #(get-in dic [% l])] [:<> [:h1.text (tr :teaching)] [:div.text (tr :introduction)]]))
